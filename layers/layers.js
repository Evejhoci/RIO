...
var lyr_DEMHUACHOCOLPA_1 = new ol.layer.Image({
                            opacity: 1,
                            title: "DEM-HUACHOCOLPA",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/DEMHUACHOCOLPA_1.png",
    attributions: ' ',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_DEMHUACHOCOLPA_1.setVisible(true);lyr_acc_2.setVisible(true);lyr_dir_3.setVisible(true);lyr_fill_4.setVisible(true);lyr_c_shp_5.setVisible(true);lyr_c_acc_6.setVisible(true);lyr_c_cauce_7.setVisible(true);lyr_c_curvas_8.setVisible(true);lyr_c_fill_9.setVisible(true);lyr_c_reclass_10.setVisible(true);lyr_c_rios_11.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_DEMHUACHOCOLPA_1,lyr_acc_2,lyr_dir_3,lyr_fill_4,lyr_c_shp_5,lyr_c_acc_6,lyr_c_cauce_7,lyr_c_curvas_8,lyr_c_fill_9,lyr_c_reclass_10,lyr_c_rios_11];
lyr_c_shp_5.set('fieldAliases', {'ID': 'ID', 'VALUE': 'VALUE', 'NAME': 'NAME', 'Area_Km2': 'Area_Km2', 'Perimer_Km': 'Perimer_Km', });
...
lyr_c_shp_5.set('fieldImages', {'ID': 'TextEdit', 'VALUE': 'TextEdit', 'NAME': 'TextEdit', 'Area_Km2': '', 'Perimer_Km': '', });
...
lyr_c_shp_5.set('fieldLabels', {'ID': 'no label', 'VALUE': 'no label', 'NAME': 'no label', 'Area_Km2': 'no label', 'Perimer_Km': 'no label', });
